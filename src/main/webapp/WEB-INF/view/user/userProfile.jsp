										...
										<div class="row">
											<div class="col-12">
												...
												<div class="form-group">
													...
													<div class="controls">
														<form:input type="text" name="City" class="form-control" placeholder="Enter City"
															path="City" required="required" 
															data-validation-containsnumber-message="This field is required" />
													</div>
												</div>
												<div class="form-group">
													<%-- <h5>
													...
													<div class="controls">
														<form:input type="text" name="TeamName" path="TeamName"
															class="form-control" required="required" id="TeamName" placeholder="Enter Team Name"
