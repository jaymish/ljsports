...
import com.openTournament.service.EventService;
import com.openTournament.service.LoginService;
import com.openTournament.service.QRService;
import com.openTournament.service.RegService;
...
public class UserEventsController {
	...
	@RequestMapping(produces = "application/json",value="/attendance",method=RequestMethod.GET)
	public void markAttendance(@RequestParam("qr")String uniqueQR,@RequestParam("eventId") int eventId,HttpServletRequest request,UserEventsVO userEventsVO7,UserProfileVO userProfileVO6,EventVO eventVO2) throws Exception
	{
		/*
		 * JSONParser parser = new JSONParser(); Object
		 * obj=parser.parse(request.getHeader("json")); JSONObject jsonObject =
		 * (JSONObject) obj; String uniqueQR=(String) jsonObject.get("qr");
		 */
